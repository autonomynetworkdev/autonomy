...
unlocked to sign the AUTONOMY-Qt.app bundle.
...
allowing somebody to distribute a AUTONOMY-Qt.app or autonomy-qt-setup.exe with a valid
...
that the autonomy-qt.exe file inside the installer had not been tampered with.
