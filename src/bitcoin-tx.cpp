...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s autonomy-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  autonomy-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded autonomy transaction") + "\n" +
              "  autonomy-tx [options] -create [commands]   " + _("Create hex-encoded autonomy transaction") + "\n" +
              "\n";
