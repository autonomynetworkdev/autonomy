...
#if defined(NDEBUG)
# error "AUTONOMY cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "AUTONOMY Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("autonomy-scriptch");
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // AUTONOMY also requires DER encoding of pubkeys
    flags |= SCRIPT_VERIFY_DERKEY;
    // AUTONOMY also requires low S in sigs
