...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"autonomyaddress\"\n"
            "\nReveals the private key corresponding to 'autonomyaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"autonomyaddress\"   (string, required) The autonomy address for the private key\n"
            "\nResult:\n"
