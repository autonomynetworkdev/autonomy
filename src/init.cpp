 ...
 * between autonomyd, and autonomy-qt and non-server tools.
*/
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/autonomynetworkdev>";
    const std::string URL_WEBSITE = "<https://autonomynetwork.org/>";
    ...
    return FormatParagraph(strprintf("Copyright (C) %i-%i The Bitcoin Core Developers", 2009, COPYRIGHT_YEAR)) + "\n" +
           ...
           "\n" +
           FormatParagraph(strprintf("Copyright (C) %i The AUTONOMY Developers", 2024)) + "\n" +
           "\n" +
           FormatParagraph(strprintf(_("Please contribute if you find AUTONOMY useful. "
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("AUTONOMY More version %s\n", FormatFullVersion());
}
