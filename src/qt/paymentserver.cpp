...
const QString BITCOIN_IPC_PREFIX("autonomy:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/autonomy-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/autonomy-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/autonomy-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click autonomy: links
...
//
// OSX-specific way of handling autonomy: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in autonomy: URIs
