...
BOOST_AUTO_TEST_CASE(test_addresses)
{
    ...
    std::vector<std::string> pubkey = {"autonomy:qpm2qsznhks23z7629mms6s4cwef74vcwvy22gdx6a",
        "autonomy:qr95sy3j9xwd2ap32xkykttr4cvcu7as4y0qverfuy",
        "autonomy:qqq3728yw0y47sqn6l2na30mcw6zm78dzqre909m2r"};
    std::vector<std::string> script = {"autonomy:ppm2qsznhks23z7629mms6s4cwef74vcwvn0h829pq",
        "autonomy:pr95sy3j9xwd2ap32xkykttr4cvcu7as4yc93ky28e",
        "autonomy:pqq3728yw0y47sqn6l2na30mcw6zm78dzq5ucqzc37"};
