...
These are the dependencies currently used by AUTONOMY. You can find instructions for installing them in the `build-*.md` file for your platform.
...
Telegram - https://t.me/autonomynl
Keybase  - https://keybase.io/team/autonomy/
